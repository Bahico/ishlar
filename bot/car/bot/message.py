...
async def bot_message(message: types.Message, conn, vote_cb, bot_):
    ...
    if bot_[0] == "start":
        ...
        if message.text == code[0]:
            ...
            markup.row(
                InlineKeyboardButton(text="🇷🇺 Pусский",callback_data=vote_cb.new(stage="language", id="start", name="None",number="10", language="rus",action="bot")),
                InlineKeyboardButton(text="🇺🇿 O'zbekcha",callback_data=vote_cb.new(stage="language", id="start", name="None",number="10", language="uzb",action="bot"))
            )
            markup.add(InlineKeyboardButton(text="🇬🇧 English",callback_data=vote_cb.new(stage="language", id="start", name="None",number="10", language="eng",action="bot")))
