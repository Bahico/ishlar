...
async def admin_edit_name(message: types.Message, conn, vote_cb, callback_query):
    """
    ...
    markup.add(
        InlineKeyboardButton(text="STOP",
                             callback_data=vote_cb.new(stage="stop", id="car_plus", name="None", number=callback_query["number"],
...
async def admin_edit_branch(message: types.Message, conn, admin):
    """
