...
async def client_message(message: types.Message, conn, vote_cb):
            ...
            try:
                ...
                for i in phone_number:
                    if son == 0:
                        ...
                        int(i)
                conn.execute("update CLIENT set settings = 'my_location', phone_number = (?)  where id = (?);",(phone_number[1:],message.from_user.id))
            ...
            try:
                ...
                for i in phone_number:
                    if son == 0:
                        ...
                        int(i)
                conn.execute("update CLIENT set settings = '0', phone_number = (?)  where id = (?);",(phone_number[1:],message.from_user.id))
