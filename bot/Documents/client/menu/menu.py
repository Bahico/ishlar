...
async def client_menu(message: types.Message, vote_cb: aiogram.utils.callback_data.CallbackData, language: str):
    markup = InlineKeyboardMarkup(resize_keyboard=True)
    if language == "uzb":
        markup.row(
            InlineKeyboardButton(text="📱 Telefon raqamim",
                                 callback_data=vote_cb.new(stage="phone_number", id="main_menu", name="None",
                                                           number="None", language=language, action="client")),
            InlineKeyboardButton(text="🇺🇿 Tilni o'zgartirish",
                                 callback_data=vote_cb.new(stage="language_edit", id="main_menu", name="None",
                                                           number="None", language=language, action="client")))
        markup.add(
            InlineKeyboardButton(text="📖 Haridlar tarixi",
                                 callback_data=vote_cb.new(stage="history", id="main_menu", name="None", number="None",
                                                           language=language, action="client"))
        )
