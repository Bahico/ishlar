...
async def client_edit_language(message: types.Message, vote_cb: aiogram.utils.callback_data.CallbackData, callback_query: dict):
...
async def client_language_edit(message: types.Message, conn: sqlite3.Connection, vote_cb: aiogram.utils.callback_data.CallbackData, callback_query: dict):
