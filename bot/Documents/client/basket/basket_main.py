...
async def client_basket(message: types.Message, conn: sqlite3.Connection,
    ...
    if basket[0] is not None:
        for spare_arr in basket[0].split("."):
            ...
            markup.row(
                InlineKeyboardButton(text=spare[0],
                                     callback_data=vote_cb.new(stage="info", id="spare_menu", name=son, number="",
                                                               language=callback_query["language"], action="client")),
                InlineKeyboardButton(text="-",
                                     callback_data=vote_cb.new(stage="-", id="spare_menu", name=son, number="",
                                                               language=callback_query["language"], action="client")),
                InlineKeyboardButton(text="+",
                                     callback_data=vote_cb.new(stage="+", id="spare_menu", name=son, number="",
                                                               language=callback_query["language"], action="client")),
                InlineKeyboardButton(text="🗑",
                                     callback_data=vote_cb.new(stage="delete", id="spare_menu", name=son, number="",
                                                               language=callback_query["language"], action="client")),
            )
        markup.row(
            InlineKeyboardButton(text="🗑 Hammasini tozalash",
                                 callback_data=vote_cb.new(stage="clear basket", id="spare_menu", name=son, number="",
                                                           language=callback_query["language"], action="client")),
            InlineKeyboardButton(text="✅Sotib olish",
                                 callback_data=vote_cb.new(stage="buy", id="spare_menu", name=son, number="",
                                                           language=callback_query["language"], action="client"))
        )
    else:
