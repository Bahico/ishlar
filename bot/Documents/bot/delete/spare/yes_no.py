...
async def bot_del_true_false(message: types.Message, vote_cb: aiogram.utils.callback_data.CallbackData, callback_query: dict, son=None):
    """
    ...
    if callback_query["language"] == "uzb":
        markup.row(
            InlineKeyboardButton(text="✅HA",
                                 callback_data=vote_cb.new(stage="yes", id="del_menu", name=callback_query["name"],
                                                           number=son, language=callback_query["language"],
                                                           action="bot")),
            InlineKeyboardButton(text="❌YO'Q",
                                 callback_data=vote_cb.new(stage="not", id="del_menu", name=callback_query["name"],
