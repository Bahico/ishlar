...
async def bot_branch_del(message: types.Message, conn: sqlite3.Connection,
    ...
    for i in branch:
        markup.insert(
            InlineKeyboardButton(text=i[0],
                                 callback_data=vote_cb.new(stage="delete", id="branch", name=i[0], number=i[1],
    ...
    if callback_query["language"] == "uzb":
        markup.row(
            InlineKeyboardButton(text="✅HA",
                                 callback_data=vote_cb.new(stage="yes", id="branch", name=callback_query["name"],
                                                           number=callback_query["number"],
                                                           language=callback_query["language"], action="bot")),
            InlineKeyboardButton(text="❌YO'Q", callback_data=vote_cb.new(stage="not", id="branch", name="not",
                                                                         number=callback_query["number"],
                                                                         language=callback_query["language"],
                                                                         action="bot"))
        )
        await bot.send_message(message.from_user.id, f"Rostan {callback_query['name']} filialini o'chirmoqchimisiz?",
                               reply_markup=markup)
    elif callback_query["language"] == "rus":
        markup.row(
            InlineKeyboardButton(text="✅ДА",
                                 callback_data=vote_cb.new(stage="yes", id="branch", name=callback_query["name"],
                                                           number=callback_query["number"],
                                                           language=callback_query["language"], action="bot")),
            InlineKeyboardButton(text="❌НЕТ", callback_data=vote_cb.new(stage="not", id="branch", name="not",
                                                                        number=callback_query["number"],
                                                                        language=callback_query["language"],
                                                                        action="bot"))
        )
        await bot.send_message(message.from_user.id, f"Вы действительно хотите удалить ветку {callback_query['name']}?",
                               reply_markup=markup)
    elif callback_query["language"] == "eng":
        markup.row(
            InlineKeyboardButton(text="✅YES",
                                 callback_data=vote_cb.new(stage="yes", id="branch", name=callback_query["name"],
                                                           number=callback_query["number"],
                                                           language=callback_query["language"], action="bot")),
            InlineKeyboardButton(text="❌NO", callback_data=vote_cb.new(stage="not", id="branch", name="not",
                                                                       number=callback_query["number"],
                                                                       language=callback_query["language"],
                                                                       action="bot"))
        )
        await bot.send_message(message.from_user.id,
                               f"Do you really want to delete the {callback_query['name']} branch?",
                               reply_markup=markup)
